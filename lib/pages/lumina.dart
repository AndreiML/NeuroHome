...
_launchURL() async {
  Uri _url = Uri.parse('https://andreiml2006.wixsite.com/neurohome/portfolio-collections/my-portfolio/project-title-1-1');
...
class _LuminaState extends State<Lumina> {
  @override
      ...
      Stack(
        children: [
          ...
          Container(
            ...
            child: Padding(
              padding: EdgeInsets.fromLTRB(30.0, 120.0, 10.0, 0.0),
              child: Column(
                children: <Widget>[
                  Row( // Primul rand
                    children: [
                      Container(
                          ...
                          child: Image.asset('assets/intrerupator_cu_senzor_4_ca_png.png')
                      ),
                      Column(
