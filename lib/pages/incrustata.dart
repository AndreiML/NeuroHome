...
class Incrustata extends StatefulWidget {
  const Incrustata({super.key});

  @override
  State<Incrustata> createState() => _IncrustataState();
}
...
_launchURL() async {
  Uri _url = Uri.parse('https://andreiml2006.wixsite.com/neurohome/portfolio-collections/my-portfolio/project-title-6-1-1-bf9b08');
...
class _IncrustataState extends State<Incrustata> {
  @override
                  ...
                  Row( // Primul rand
                    children: [
                      Container(
                          ...
                          child: Image.asset('assets/priza_ingropata_cu_senzor.jpg')
                      ),
                      Column(
