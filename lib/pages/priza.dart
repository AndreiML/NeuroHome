...
class Priza extends StatefulWidget {
  const Priza({super.key});

  @override
  State<Priza> createState() => _PrizaState();
}
...
_launchURL() async {
  Uri _url = Uri.parse('https://andreiml2006.wixsite.com/neurohome/portfolio-collections/my-portfolio/project-title-6-1-eaa798');
...
class _PrizaState extends State<Priza> {
  @override
                    ...
                    Row( // Primul rand
                      children: [
                        Container(
                            ...
                            child: Image.asset('assets/priza_1.jpg')
                        ),
                        Column(
