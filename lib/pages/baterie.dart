...
_launchURL() async {
  Uri _url = Uri.parse('https://andreiml2006.wixsite.com/neurohome/portfolio-collections/my-portfolio/project-title-5-1');
                  ...
                  Row( // Primul rand
                    children: [
                      Container(
                          ...
                          child: Image.asset('assets/baterii_cu_senzor_3.jpeg')
                      ),
                      Column(
