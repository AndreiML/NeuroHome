...
class Ajutor extends StatefulWidget {
  const Ajutor({super.key});

  @override
  State<Ajutor> createState() => _AjutorState();
}
...
_launchURL() async {
  Uri _url = Uri.parse('https://andreiml2006.wixsite.com/neurohome/portfolio-collections/my-portfolio/project-title-1-1-1');
...
class _AjutorState extends State<Ajutor> {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradientPainter(
                colors: [
                  dayOrNight ? Color(0xFFffffff) : Color(0xFFffffff),
                  dayOrNight ? Color(0xFF28208C) : Color(0xFF28208C),
                  //Color(0xFF28208C),
                  //Color(0xFF215bad),
                  //Color(0xFF23b0ba),
                  //Color(0xFF1fd17b),
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    fixedSize: Size(20, 50), // Adjust width and height as needed
                  ),
                  onPressed: () async {
                    final feedback = await openDialog();
                  ...
                  Row( // Primul rand
                    children: [
                      Container(
                          ...
                          child: Image.asset('assets/centrala.jpg')
                      ),
                      Column(
  ...
  Future<String?> openDialog() => showDialog<String>(
    ...
    builder: (context) => AlertDialog(
      title: Text('Descrieți ce problemă ați întâmpinat'),
      content: TextField(
        autofocus: true,
        controller: controller,
        decoration: InputDecoration(hintText: 'Textul dumneavoastră'),
      ),
      actions: [
        TextButton(
            onPressed: submit,
            child: Text('Trimiteți.')
        ),
      ],
    ),
  );
